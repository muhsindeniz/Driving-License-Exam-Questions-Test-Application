...
public class Subat_Sekiz extends AppCompatActivity {
    ...
    CountDownTimer mCountDownTimer = new CountDownTimer(mMilliseconds, 1000) {
        ...
        public void onFinish() {
            ...
            AlertDialog.Builder mesaj = new AlertDialog.Builder(Subat_Sekiz.this);
            ...
            mesaj.setPositiveButton("TEKRAR ÇÖZ", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent git = new Intent(Subat_Sekiz.this, Subat_Sekiz.class);
                    startActivity(git);
                }
            });
            ...
            mesaj.setNegativeButton("ANASAYFA", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent git = new Intent(Subat_Sekiz.this, MainActivity.class);
                    startActivity(git);
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subat__sekiz);
        ...
        mesaj.setPositiveButton("Başla", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Subat_Sekiz.this, "Sınav Başladı..", Toast.LENGTH_LONG).show();
        ...
        CevapA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (soru == 50) {
                    ...
                    Toast.makeText(Subat_Sekiz.this, "SINAV BİTTİ..", Toast.LENGTH_LONG).show();
